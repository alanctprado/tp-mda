...
def main():
    ...
    print(f"Downloaded users from {sum(result)} / {len(result)} contests")
#     print(f"Downloaded users and ratings from {sum(result)} / {len(result)} contests")
#     with ProcessPoolExecutor(max_workers=max_workers) as executor:
